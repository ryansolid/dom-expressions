...
import { cleanChildren, appendNodes, normalizeIncomingArray } from "./utils";
import { root, effect, memo, config, getHydrationKey } from "./runtime";
import reconcileArrays from "./reconcile";

const eventRegistry = new Set();

export { currentContext, createComponent } from "./runtime";
export { effect, memo, getHydrationKey };
...
export function hydrate(code, element) {
  config.hydrate = { id: "0", count: 0, registry: {} };
