...
const fixture3 = `<span> Hello &lt;div/><script nonce="1a2s3d4f5g">(e=>{let t=e=>e&&e.hasAttribute&&(e.hasAttribute("data-hk")?e:t(e.host&&e.host.nodeType?e.host:e.parentNode));["click", "input"].forEach((o=>document.addEventListener(o,(o=>{let a=o.composedPath&&o.composedPath()[0]||o.target,d=t(a);d&&!e.completed.has(d)&&e.events.push([d,o])}))))})(window._$HY||(_$HY={events:[],completed:new WeakSet,r:{},fe(){},load:e=>_$HY.r[e],has:e=>e in _$HY.r}));var $R=[],$P=(e,$,r)=>((r=new Promise(((r,u)=>{e=r,$=u}))).s=e,r.f=$,r),$uP=(e,$)=>{delete($=$R[e]).s,delete $.f},$Ps=(e,$,r)=>{(r=$R[e]).s($),r.value=$,$uP(e)},$Pf=(e,$)=>{$R[e].f($),$uP(e)},$uS=e=>delete e.c,$Se=(e,$,r,u,s)=>{switch(s=(u=$R[e]).c,$){case 0:return s.enqueue(r);case 1:return s.error(r),$uS(u);case 2:return s.close(),$uS(u)}},$S=(e,$)=>((e=new ReadableStream({start(e){$=e}})).c=$,e);</script><!--xs--><link rel="modulepreload" href="chunk.js"></span>`;
