...
const trailingExpr = _$ssr`<span _hk="${_$getHydrationKey()}">Hello <!--#-->${name}<!--/--></span>`;
const leadingExpr = _$ssr`<span _hk="${_$getHydrationKey()}"><!--#-->${greeting}<!--/--> John</span>`;
/* prettier-ignore */

const multiExpr = _$ssr`<span _hk="${_$getHydrationKey()}"><!--#-->${greeting}<!--/--> <!--#-->${name}<!--/--></span>`;
/* prettier-ignore */

const multiExprSpaced = _$ssr`<span _hk="${_$getHydrationKey()}"> <!--#-->${greeting}<!--/--> <!--#-->${name}<!--/--> </span>`;
/* prettier-ignore */
