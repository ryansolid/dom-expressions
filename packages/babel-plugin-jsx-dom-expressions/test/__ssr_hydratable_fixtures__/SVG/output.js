...
const _tmpl$ = [
  ...
  _tmpl$3 = ['<svg data-hk="', '" width="400" height="180"><rect ', "></rect></svg>"],
  _tmpl$4 = ['<rect data-hk="', '" x="50" y="20" width="150" height="150"></rect>'],
  _tmpl$5 = [
    '<svg data-hk="',
...
const template3 = _$ssr(_tmpl$3, _$getHydrationKey(), _$ssrSpread(props, true, false));

const template4 = _$ssr(_tmpl$4, _$getHydrationKey());

const template5 = _$ssr(_tmpl$4, _$getHydrationKey());

const template6 = _$createComponent(Component, {
  get children() {
    return _$ssr(_tmpl$4, _$getHydrationKey());
  }
});

const template7 = _$ssr(_tmpl$5, _$getHydrationKey(), _$escape(url, true));

const template8 = _$ssr(_tmpl$6, _$getHydrationKey(), _$escape(text));
