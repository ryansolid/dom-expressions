...
const template4 = _$ssrAsync('<rect x="50" y="20" width="150" height="150"></rect>');

const template5 = _$ssrAsync('<rect x="50" y="20" width="150" height="150"></rect>');

const template6 = _$createComponent(
  Component,
  {
    children: () => _$ssrAsync('<rect x="50" y="20" width="150" height="150"></rect>')
  },
  _ck$
);
