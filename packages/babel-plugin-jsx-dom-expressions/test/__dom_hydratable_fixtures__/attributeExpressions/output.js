...
const template31 = (() => {
  ...
  _$effect(_$p =>
    _$setStyleProperty(_el$48, "background-color", (_$p = getStore.itemProperties.color))
  );
  return _el$48;
})();
const template32 = (() => {
  var _el$49 = _$getNextElement(_tmpl$4);
  _$setStyleProperty(_el$49, "background-color", undefined);
  return _el$49;
})();
const template33 = [
  (() => {
...
const template40 = (() => {
  ...
  _$effect(_$p => _$setStyleProperty(_el$60, "color", (_$p = a())));
  return _el$60;
})();
const template41 = (() => {
